...
import { Brain, TrendingDown, Zap, Users, Info } from "lucide-react"
            ...
            <Card className={cn(dispositionRatio !== null && dispositionRatio > 1.2 && "border-amber-300 dark:border-amber-800")}>
              <CardHeader className="pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger className="text-muted-foreground/60 hover:text-muted-foreground">
                      <Info className="size-3.5" />
                    </TooltipTrigger>
                    <TooltipContent side="top" className="max-w-[240px] text-xs">
                      <p>Ratio of how long you hold losing trades vs winning ones. Above 1× means you let losses run longer than profits — a common and costly habit.</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              </CardHeader>
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="top" className="max-w-[240px] text-xs">
                      <p>Your win rate on trades entered within 60 minutes of a loss. A big drop from your baseline means you trade emotionally after losing — often giving back even more.</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              </CardHeader>
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="top" className="max-w-[240px] text-xs">
                      <p>Total P&L from trades you entered based on tips, Twitter calls, or social pressure — with no independent analysis. Negative numbers here are a clear sign to stop following the crowd.</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              </CardHeader>
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="top" className="max-w-[240px] text-xs">
                      <p>Generated by Groq (llama-3.3-70b) from your weekly bias numbers. Refreshes once per hour alongside the report.</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              </CardHeader>
